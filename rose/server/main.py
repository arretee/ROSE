...
def main():
    ...
    same place for both drivers, otherwise, the obstacles will be generated in
    ...
    """
    If the argument is "-r <path of file(json) to read>", the track will created from file with data.
    Otherwise track will generated by default. 
    Server can read only json type file. 
    ...
    """
    If the argument is "-w <path of file(json) to save the track>", Generated track will saved in path that
    user wrote.
    template of json file - 
    [
    ["", "", "", "", "", ""],
