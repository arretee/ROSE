...
def main():
    ...
    """
    If the argument is "-r <path of file to read>", the track will created from file with data.
    ...
    """
    If the argument is "-w <path of file to save the track>", Generated track will saved in path that
    user wrote.
    """
